...
/**
 * Clase que encapsula la informaci�n relativa a la evaluaci�n
...
public class Alumno {
	 ...
	 * @param dni DNI del alumno (�nico para cada alumno)
	 */
	...
	/**
	 * Metodo de consulta del DNI (�nico para cada alumno)
