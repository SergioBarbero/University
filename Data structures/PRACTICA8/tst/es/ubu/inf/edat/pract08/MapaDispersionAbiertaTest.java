...
public class MapaDispersionAbiertaTest {
	...
	/**
	 * Se comprueba el almacenamiento correcto de claves y valores.
	 * Se comprueba también el tamaño del mapa y el numero de entradas registradas.
	 */
	@Test
	public void testPut_Espacio() {
		...
		assertEquals(5,mapa.getNumberBuckets());
		
	}

	/**
	 * Se comprueba el almacenamiento correcto de claves y valores en el caso de necesitar
	 * un redimensionamiento de la tabla mientras se almacena. 
	 * Se comprueba también el tamaño del mapa y el numero de entradas registradas. 
	 */
	@Test
	public void testPut_SinEspacio() {
		...
		assertEquals(7, mapa.getNumberBuckets());
		
	}

	/**
	 * Se comprueba que en el caso de almacenar un par-valor de una clave que ya existe en el mapa
	 * se actualizan correctamente los valores.
	 */
	@Test
	...
	/**
	 * Se comprueba la eliminacion de claves y valores en función de
	 * la búsqueda por clave.
	 */
	@Test
	...
	/**
	 * Se comprueba la correcta recuperación del conjunto de
	 * pares clave-valor almacenados.
	 */
	@Test
	...
	/**
	 * Se comprueba a recuperar los valores a partir de sus claves
	 * tras haber realizado una inserción sin necesidad de redimension.
	 */
	@Test
	...
	/**
	 * Se comprueba a recuperar los valores a partir de sus claves
	 * tras haber realizado una inserción con necesidad de redimension.
	 */
	@Test
