...
public class LinearProbing<K, V> {
    ...
    public V search(K key){
      ...
      //  System.out.println("Hash code of " + key + ": " + index);
        ...
        while(keys.get(index) != key){
            tries++;
            if(keys.get(index) == null || tries == size) {
                averageHits += tries;
                return null;
            }
            index = (index + 1) % size;
    ...
    public static void initStrings(int size, int capacity){
        ...
        LinearProbing<String, String> strings = new LinearProbing<>(size);
    ...
    public static void initIntegers(int size, int capacity){
        ...
        LinearProbing<Integer, Integer> integers = new LinearProbing<>(size);
